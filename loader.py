...
def read_category():
    ...
    categories = ['儿科','耳鼻咽喉科', '风湿免疫科', '妇产科', '感染科 传染科', '骨科', '呼吸内科', '甲状腺乳腺外科', '精神心理科',
    '口腔科','泌尿外科','内分泌科','皮肤科','普通内科','普外科','神经内科','神经外科','疼痛科 麻醉科',
    '消化内科','心血管内科','性病科','血液科','眼科','疫苗科','影像检验科','肿瘤科','肛肠外科','中医科','胸外科',
    '烧伤科','整形科','乳腺外科','肝胆外科','急诊科','头颈外科','心胸内科']
